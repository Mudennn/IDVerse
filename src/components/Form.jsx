    ...
    <section className="max-w-screen-lg mx-auto py-8">
      ...
      <div className="mt-4 flex gap-3 gap-y-5 text-left">
        <div className="md:w-1/2 px-3 mb-6 md:mb-0">
          <label htmlFor="" className="mb-1 font-semibold text-gray-500">
            First Name
          </label>
          <input
            type="text"
      ...
      <div className="mt-5 ml-3">
        <button className="my-2 flex w-32 items-center justify-center rounded-lg bg-blue-700 py-2 text-center font-bold text-white outline-none transition focus:ring">
          Save
        </button>
      </div>
    </section>
